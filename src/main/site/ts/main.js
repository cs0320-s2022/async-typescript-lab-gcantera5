...
const sunChange = document.querySelector('#sun');
const moonChange = document.querySelector("#moon");
const risingChange = document.querySelector('#rising');
...
function postAndUpdate() {
    ...
    const postParameters = {
        sun: sunChange.value,
        moon: moonChange.value,
        rising: risingChange.value
